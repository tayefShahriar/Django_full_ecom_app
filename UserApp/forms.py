...
from django.forms import ModelForm, NumberInput, EmailInput, PasswordInput, Select, FileInput, TextInput
...
class signUpForm(UserCreationForm):
    ...
    last_name = forms.CharField(max_length=100, label="last_name", widget=forms.TextInput(
        attrs={'placeholder': 'Write your last_name', }
    ))
    ...
    class Meta:
        ...
        widgets = {
            ...
            'password2': forms.PasswordInput(
                attrs={'placeholder': 'Enter Repeat Password', 'class': 'form-control'}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            'first_name': TextInput(attrs={
                'class': 'input', 'placeholder': 'first_name'
            }),
            'last_name': TextInput(attrs={
                'class': 'input', 'placeholder': 'last_name'
            }),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            'country': TextInput(attrs={
                'class': 'input', 'placeholder': 'country'
            }),
            'image': FileInput(attrs={
                'class': 'input', 'placeholder': 'image'
            }),
        }